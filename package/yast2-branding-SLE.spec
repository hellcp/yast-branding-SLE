...
%package -n yast2-qt-branding-SLE
Summary:        Theming for YaST2 Qt
License:        GPL-2.0-only
Group:          System/YaST
Supplements:    ((yast2 and libyui-qt) and branding-SLE)
Conflicts:      yast2-qt-branding
Provides:       yast2-qt-branding = %{version}
BuildArch:      noarch

%description -n yast2-qt-branding-SLE
SLE branding for YaST2 Qt, mainly used for installation
